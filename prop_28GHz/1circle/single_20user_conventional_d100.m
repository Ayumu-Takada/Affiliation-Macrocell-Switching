...
time_indicator = TimeIndicator("20user100m",num_trial);
time_indicator.start();
for rng_value = trial_start:trial
    rng(rng_value);
    num_macro_cell = 19;
    num_users = 20;                   % # of users
    distance = 100;                   %distance between BSs
...
% end                    
    ...
    saveDirStr = (['result/conventional_28GHz/',num2str(num_users),'user']);
    save([saveDirStr, '/',...

...
for u = 1:numel(distance)
    ...
    for rng = num_start:num_end
        load(['./result/proposed_p1_th4/',num2str(num_users),'user/result_d',num2str(distance(u)),'_rng',num2str(rng),'.mat'],'cumulative_throughput')
    ...
    hold on
    if u == 1
        plot(50, Throughput_PF,'.b','MarkerSize',30)
    elseif u == 2
        plot(100, Throughput_PF,'.r','MarkerSize',30)
    elseif u == 3
        plot(150, Throughput_PF,'.k','MarkerSize',30)
    elseif u == 4
        plot(200, Throughput_PF,'.g','MarkerSize',30)
    % else
    ...
    % proposed_p2
    for rng = num_start:num_end
        load(['./result/proposed_p1_th2/',num2str(num_users),'user/result_d',num2str(distance(u)),'_rng',num2str(rng),'.mat'],'cumulative_throughput')
    ...
    hold on
    if u == 1
        plot(50, Throughput_PF2,'pb','MarkerSize',10)
    elseif u == 2
        plot(100, Throughput_PF2,'pr','MarkerSize',10)
    elseif u == 3
        plot(150, Throughput_PF2,'pk','MarkerSize',10)
    elseif u == 4
        plot(200, Throughput_PF2,'pg','MarkerSize',10)
    % else
    %     plot(Fairness_Index_PF2, Throughput_PF2,'pc','MarkerSize',10)
    end
    ...
    % else
    %     plot(Fairness_Index_PF4, Throughput_PF4,'*c','MarkerSize',10)
    % end
    % hold off
...
ylim([1.5 4])
box on
xlabel('Distance (m)','FontSize',10,'FontName','Arial')
...
% str = {'Nu=5,15,20'};
% text(0.332,0.44,str)
saveas(gcf,"result\fig\Figure_distance_axis\4.65GHz\" + num_users + "user.fig")